...
FuncReturn_t DRVConfigureRTC(crm_rtc_timingReference_t mTimingRef, uint32_t mTimeout, callback_t pfUserCallbackFn){
  ...
  if ( ( gMaxRtcTimingReference_c <= mTimingRef ) ) {
    return gFailOutOfRange_c;
  }
  else if ( (( void * )( 0 )) == pfUserCallbackFn ){
    return gFailOutOfRange_c;
  }

  ((CrmRegs_t *)0x80003000)->RtcTimeout = mTimeout;
  
  if ( gTimerRef_2Khz_c == mTimingRef ) {
    ((crmRingOsclCntlReg_t*)&((CrmRegs_t *)0x80003000)->RingOsclCntl)->bit . rOscEn = 1;
    ((crmXtal32CntlReg_t*)&((CrmRegs_t *)0x80003000)->Xtal32Cntl)->bit . xtal32En = 0;;
  }
  else if (gTimerRef_32Khz_c == mTimingRef) {
    CRM_2kToXtal32Switch(1, (( void * )( 0 ))); 
  }
  else {
    /* Do nothing */
  }
  ...
  {
    ((crmWuCntlReg_t*)&((CrmRegs_t *)0x80003000)->WuCntl)->bit . rtcWuIEn = 1;
    return gSuccess_c;
  }
  else {
     return gFail_c;
