...
void StartNvmReg(void)
{
  ...
  (*((volatile unsigned long*)(0x80003048))) &= (~0x00000001UL);
  (*((volatile unsigned long*)(0x80003048))) |= 0x00000004UL;

  counter = 18200;
  while(counter--);

  (*((volatile unsigned long*)(0x80003048))) |= 0x00000080UL;
  counter = 5200;
  while(counter--);
}
...
static void PlatformInitGpio(void)
{
  ((GpioRegs_t *)0x80000000)->DataLo = 0x03c00000;                  //MBAR_GPIO + 0x08
  ((GpioRegs_t *)0x80000000)->DataHi = 0x00000000;                  //MBAR_GPIO + 0x0C

  ((GpioRegs_t *)0x80000000)->DirLo =  0x03c00000;                   //MBAR_GPIO + 0x00
  ((GpioRegs_t *)0x80000000)->DirHi =  0x00000000;                   //MBAR_GPIO + 0x04

  ((GpioRegs_t *)0x80000000)->PuEnLo = 0xffffffff;                  //MBAR_GPIO + 0x10
  ((GpioRegs_t *)0x80000000)->PuEnHi = 0xffffffff;                  //MBAR_GPIO + 0x14
  ((GpioRegs_t *)0x80000000)->FuncSel0 = 0x00000000;              //MBAR_GPIO + 0x18
  ((GpioRegs_t *)0x80000000)->FuncSel1 = 0x00000000;              //MBAR_GPIO + 0x1C
  ((GpioRegs_t *)0x80000000)->FuncSel2 = 0x00000000;              //MBAR_GPIO + 0x20
  ((GpioRegs_t *)0x80000000)->FuncSel3 = 0x00000000;              //MBAR_GPIO + 0x24
  ((GpioRegs_t *)0x80000000)->InputDataSelLo = 0x00000000;  //MBAR_GPIO + 0x28
  ((GpioRegs_t *)0x80000000)->InputDataSelHi = 0x00000000;  //MBAR_GPIO + 0x2C
  ((GpioRegs_t *)0x80000000)->PuSelLo = 0x00003000;                //MBAR_GPIO + 0x30
  ((GpioRegs_t *)0x80000000)->PuSelHi = 0x8001c000;                //MBAR_GPIO + 0x34
  ((GpioRegs_t *)0x80000000)->HystEnLo = 0x00000000;              //MBAR_GPIO + 0x38
  ((GpioRegs_t *)0x80000000)->HystEnHi = 0x00000000;              //MBAR_GPIO + 0x3C
  ((GpioRegs_t *)0x80000000)->PuKeepLo = 0xc0000000;              //MBAR_GPIO + 0x40
  ((GpioRegs_t *)0x80000000)->PuKeepHi = 0x000000df;              //MBAR_GPIO + 0x44 
}
