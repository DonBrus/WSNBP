...
#define MAX_POWER     0x11

#define gNumChannNotOnPALock_c (gChannel26_c - gChannel25_c)
#define gNumPowerLvlNotOnPALock_c (7)


#if gPowerLevelLock_c == TRUE
  #define NOM_POWER     0x07
#else
